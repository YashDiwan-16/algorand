...
from smart_contracts.artifacts.manage.manage_client import (
    ManageClient,
    ManageFactory,
)
...
def manage_client(
    ...
    factory = algorand_client.client.get_typed_app_factory(
        ManageFactory, default_sender=deployer.address
    )
...
def test_says_hello(manage_client: ManageClient) -> None:
    result = manage_client.send.hello(args=("World",))
